  ...
  switch(numeroServo){
      case 3:
        for (pos = servo3.read(); pos <= anguloServo; pos += 1) {
          servo3.write(pos);
          Serial.print("Servo 3: "); Serial.print(servo3.read());            
          delay(tiempoRetardo);                       
        }
      break;
      case 6:
        for (pos = servo6.read(); pos <= anguloServo; pos += 1) { 
          ...
          Serial.print("Servo 5 (GEMELO 6): "); Serial.print(servo5.read());
          Serial.print("Servo 6: "); Serial.print(servo6.read());        
          delay(tiempoRetardo);                       
        }
      break;
      case 9:
        for (pos = servo9.read(); pos <= anguloServo; pos += 1) { 
          servo9.write(pos);
          Serial.print("Servo 9: "); Serial.print(servo9.read());             
          delay(tiempoRetardo);                       
        }
      break;
      case 10:
        for (pos = servo10.read(); pos <= anguloServo; pos += 1) { 
          servo10.write(pos);
          Serial.print("Servo 10: "); Serial.print(servo10.read());      
          delay(tiempoRetardo);                       
        }
      break;
      case 11:
        for (pos = servo11.read(); pos <= anguloServo; pos += 1) { 
          servo11.write(pos);
          Serial.print("Servo 11: "); Serial.print(servo11.read());           
          delay(tiempoRetardo);                       
        }
      break;
      default:
